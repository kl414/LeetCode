/**
 * The explanation is so good so I kept it as reference,
 * also the original code is buy = Int_min, but I think -prices[0] makes more sense to myself
 * Combining rest[i] into sell[i] and makes buy[i] to compare sell[i-2] seems more straight forward 
 * for the definition of cooldown, but again this is for the thinking process.
 * 
